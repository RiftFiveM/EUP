RegisterServerEvent('FvMain:DebugSomething')
AddEventHandler('FvMain:DebugSomething', function(resource, obj, depth)
...
FvMain.Debug = function(resource, obj, depth)
    TriggerEvent('FvMain:DebugSomething', resource, obj, depth)
end

FvMain.ShowError = function(resource, msg)
    print("\x1b[31m["..resource..":ERROR]\x1b[0m "..msg)
end

FvMain.ShowSuccess = function(resource, msg)
