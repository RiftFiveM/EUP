...
$('.cityhall-option-block').click(function(e){
    ...
    if (blockPage == "identity") {
        ...
        $(".identity-page-blocks").html('<div class="identity-page-block" data-type="id-card"><p>ID Card</p></div>');

        $.post('https://fvm-cityhall/requestLicenses', JSON.stringify({}), function(licenses){
...
$(".request-identity-button").click(function(e){
    ...
    $.post('https://fvm-cityhall/requestId', JSON.stringify({
...
$(document).on('click', '.apply-job-button', function(e){
    ...
    $.post('https://fvm-cityhall/applyJob', JSON.stringify({
        job: selectedJobId
    }))
