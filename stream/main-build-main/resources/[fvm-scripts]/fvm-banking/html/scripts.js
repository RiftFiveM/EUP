...
$(document).ready(function(){
  ...
  document.onkeyup = function (data) {
    if (data.which == 27 ) {
      $.post('http://fvm-banking/close', JSON.stringify({}));
    }
  };
  // Handle Button Presses
  $(".btnWithdraw").click(function(){
      $.post('http://fvm-banking/withdraw', JSON.stringify({}));
  });
  $(".btnDeposit").click(function(){
      $.post('http://fvm-banking/deposit', JSON.stringify({}));
  });
  $(".btnBalance").click(function(){
      $.post('http://fvm-banking/balance', JSON.stringify({}));
  });
  $('.btnQuick').click($.throttle( 2000, true, function(e){
    $.post('http://fvm-banking/quickCash', JSON.stringify({}));
  }));
  $(".btnTransfer").click(function(){
    $.post('http://fvm-banking/transfer', JSON.stringify({}));
  });
  ...
  $("#withdraw-form").submit(function(e) {
      ...
      if (amount >= 0 ) {
        $.post('http://fvm-banking/withdrawSubmit', JSON.stringify({
  ...
  $("#deposit-form").submit(function(e) {
      ...
      if (amount >= 0 ) {
        $.post('http://fvm-banking/depositSubmit', JSON.stringify({
  ...
  $("#transfer-form").submit(function(e) {
    e.preventDefault();
    $.post('http://fvm-banking/transferSubmit', JSON.stringify({
