...
RegisterNetEvent('fvm-banking:client:SetBankClosed')
AddEventHandler('fvm-banking:client:SetBankClosed', function(BankId, bool)
...
function openGui()
  ...
  FvMain.Functions.Progressbar("use_bank", "Card is being read..", 2500, false, true, {}, {}, {}, {}, function() 
...
function IsNearPlayer(player)
  ...
  local distance = #(vector3(ply2Coords["x"], ply2Coords["y"], ply2Coords["z"],  plyCoords["x"]) - vector3(plyCoords["x"], plyCoords["y"], plyCoords["z"]))
  if(distance <= 5) then
    return true
  end
end
...
AddEventHandler('banking:client:CheckDistance', function(targetId, amount)
  ...
  if player ~= -1 and distance < 2.5 then
    ...
    FvMain.Functions.Notify('You are not close to the person.', 'error')
  end
end)