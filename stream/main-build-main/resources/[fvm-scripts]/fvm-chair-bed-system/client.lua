        ...
        if isWithinObject and oElement.fObject ~= 0 then
            ...
            if (distanceDiff < 2.0 and not InUse) then
                if (oElement.fObjectIsBed == true) then
                    ...
                    if IsControlJustPressed(0, Config.objects.ButtonToLayOnBed) then
                        TriggerServerEvent('fvm-chair-bed-system:Server:Enter', oElement, oElement.fObjectCoords)
                    end
                else    
            ...
            if (InUse) then
                ...
                if IsControlJustPressed(0, Config.objects.ButtonToStandUp) then
                    InUse = false
                    TriggerServerEvent('fvm-chair-bed-system:Server:Leave', oElement.fObjectCoords)
...
RegisterNetEvent('fvm-chair-bed-system:Client:Animation')
AddEventHandler('fvm-chair-bed-system:Client:Animation', function(v, coords)
