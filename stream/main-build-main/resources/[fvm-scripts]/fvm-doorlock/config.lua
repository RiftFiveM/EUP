...
-- support for object number and object name
-- objName = 5125645465, or objName = GetHashKey('prop_gate_prison_01')
FVM.Doors = {
	-- Prison Door 1
	{
...

	{
		...
		doors = {
			{
				objName = GetHashKey('v_ilev_ph_door01'),
				objYaw = -90.0,
				objCoords = vector3(434.7, -980.6, 30.8)
			},

			{
				objName = GetHashKey('v_ilev_ph_door002'),
				objYaw = -90.0,
	...
	{
		objName = GetHashKey('v_ilev_ph_gendoor004'),
		objYaw = 90.0,
	...
	-- Rooftop
	{
		objName = GetHashKey('v_ilev_gtdoor02'),
		objYaw = 90.0,
	...
	-- Hallway to roof
	{
		objName = GetHashKey('v_ilev_arm_secdoor'),
		objYaw = 90.0,
	...
	-- Captain Office
	{
		objName = GetHashKey('v_ilev_ph_gendoor002'),
		objYaw = -180.0,
	...
	-- To downstairs (double doors)
	{
		...
		doors = {
			{
				objName = GetHashKey('v_ilev_ph_gendoor005'),
				objYaw = 180.0,
	...
	-- Main Cells
	{
		objName = GetHashKey('v_ilev_ph_cellgate'),
		objYaw = 0.0,
	...
	-- To Back
	{
		objName = GetHashKey('v_ilev_gtdoor'),
		objYaw = 0.0,
	...
	-- Back (double doors)
	{
		...
		doors = {
			{
				objName = GetHashKey('v_ilev_rc_door2'),
				objYaw = 0.0,
	...
	-- To Photoroom
	{
		objName = GetHashKey('v_ilev_ph_gendoor006'),
		objYaw = 0.0,
	...
	-- Entree cellen 1
	{
		objName = GetHashKey('v_ilev_ph_cellgate1'),
		objYaw = 45.0,
	...
	--
	-- Bolingbroke Penitentiare

	--outside doors
	{
		objName = GetHashKey('prop_fnclink_03gate5'),
	...
	-- To VisitorRoom
	{
		objName = GetHashKey('prison_prop_door2'),
		objYaw = 90.0,
	...
	{
		objName = GetHashKey('prison_prop_door1'),
		objYaw = 0.0,
	...
	},
	{
		...
		doors = {
			...
			{
				objName = GetHashKey('prison_prop_door1a'),
				objYaw = 0.0,
	...
	-- First Door
	{
		objName = GetHashKey('hei_v_ilev_bk_gate_pris'),			
	...
	-- Second Door
	{
		objName = GetHashKey('hei_v_ilev_bk_gate2_pris'),
	...
	-- Office to gate door
	{
		objName = GetHashKey('v_ilev_bk_door'),
	...
	-- First safe Door
	{
		objName = GetHashKey('hei_v_ilev_bk_safegate_pris'),
	...
	-- Door 1
	{
		objName = GetHashKey('v_ilev_gb_vaubar'),
	...
	-- Paleto Door 1
	{
		objName = GetHashKey('v_ilev_cbankvaulgate01'),
	...
	-- Paleto Door 2
	{
		objName = GetHashKey('v_ilev_cbankvaulgate02'),
	...
	-- Entrance Doors 
	{
		...
		authorizedJobs = { 'cardealer', 'police', 'sheriff' },
		locking = false,
		locked = true,
		pickable = false,
		distance = 3.5,
		doors = {
			{
				objName = GetHashKey('prop_doorluxyry2'),
				objYaw = 120.0,
	...
	-- Side Entrance Doors 
	{
		...
		doors = {
			{
				objName = GetHashKey('prop_doorluxyry'),				
				objYaw = -160.0,
	...
	-- Garage Doors
	{
		...
		doors = {
			{
				objName = GetHashKey('prop_autodoor'),
	...
	-- Voordeur 1
	{
		objName = GetHashKey('apa_prop_apa_cutscene_doorb'),
	...
	-- Roldeur
	{
		objName = GetHashKey('prop_com_gar_door_01'),
