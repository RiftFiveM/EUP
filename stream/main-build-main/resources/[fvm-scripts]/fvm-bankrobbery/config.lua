...
Config.MarkedBillsSmallBank = math.random(4000, 6000)
Config.MarkedBillsPaletoBank = math.random(11000, 13000)
Config.MarkedBillsPacificBank = math.random(19000, 21000)
