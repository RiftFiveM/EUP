    ...
    while true do
        ...
        if PaletoDist < 15 then
            ...
            if Config.BigBanks["paleto"]["isOpened"] then
                --TriggerServerEvent('fvm-doorlock:server:updateState', 85, false)
                ...
                --TriggerServerEvent('fvm-doorlock:server:updateState', 85, true)
                local object = GetClosestObjectOfType(Config.BigBanks["paleto"]["coords"]["x"], Config.BigBanks["paleto"]["coords"]["y"], Config.BigBanks["paleto"]["coords"]["z"], 5.0, Config.BigBanks["paleto"]["object"], false, false, false)
...
RegisterNetEvent('fvm-bankrobbery:client:ClearTimeoutDoors')
AddEventHandler('fvm-bankrobbery:client:ClearTimeoutDoors', function()
    TriggerServerEvent('fvm-doorlock:server:updateState', 38, true)
