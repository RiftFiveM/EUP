...
FvMain.Functions.CreateCallback('fvm-builderjob:server:GetCurrentProject', function(source, cb)
...
RegisterServerEvent('fvm-builderjob:server:SetTaskState')
AddEventHandler('fvm-builderjob:server:SetTaskState', function(Task, IsBusy, IsCompleted)
    ...
    TriggerClientEvent('fvm-builderjob:client:SetTaskState', -1, Task, IsBusy, IsCompleted)
end)

RegisterServerEvent('fvm-builderjob:server:FinishProject')
AddEventHandler('fvm-builderjob:server:FinishProject', function()
    ...
    TriggerClientEvent('fvm-builderjob:client:FinishProject', -1, Config)
end)